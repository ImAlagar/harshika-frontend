          ...
          <AnimatePresence>
            {success && (
              <motion.div 
                ...
                exit={{ opacity: 0, height: 0 }}
                transition={{ duration: 0.3 }}
                className="bg-green-500/20 border border-green-500 text-green-300 px-4 py-3 rounded-lg mb-6 text-sm overflow-hidden text-center font-inter"
              >
                {success}
              </motion.div>
            )}
